export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote OwkHub server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'OwkHub Cloud',
