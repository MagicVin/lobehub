export default {
  ...
  'createGuide.func1.title': 'Submit in OwkHub',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the OwkHub Community.',
  'footer.title': 'Share your creation on OwkHub Community today',
  ...
  'models.providerInfo.apiTooltip': 'OwkHub supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'OwkHub Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on OwkAI',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by OwkHub automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the OwkHub marketplace with one click.',
