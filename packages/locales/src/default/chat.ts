export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by OwkHub Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'OwkHub could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'OwkHub could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'OwkHub optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to OwkHub',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not OwkHub's, and OwkHub takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'Owk AI will run this task when no assignee is set',
