export default {
  ...
  'protocolInstall.official.badge': 'OwkHub Official Skill',
  'protocolInstall.official.description': 'Official OwkHub Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. OwkHub does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to Owk AI',
