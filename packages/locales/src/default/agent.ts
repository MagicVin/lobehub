export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to OwkHub. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with OwkHub on Slack, Discord, Telegram.',
  ...
  'channel.imessage.description':
    'Connect this assistant to iMessage through the local OwkHub Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in OwkHub Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and OwkHub Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, OwkHub Desktop receives local BlueBubbles webhooks and forwards them to OwkHub.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to OwkHub. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to OwkHub. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to OwkHub, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The OwkHub Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between OwkHub Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
